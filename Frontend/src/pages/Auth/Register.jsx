...
function Register() {
  ...
  return (
    <section className="flex justify-center items-center min-h-screen bg-misty-blue">
      <div className="w-[90%] md:w-1/2 bg-white p-8 shadow-lg rounded-lg">
        ...
        <form onSubmit={registerHandler} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="bg-deep-slate text-white rounded px-4 py-2 cursor-pointer hover:bg-slate-800 w-full"
          >
